...
extension CategoryModelQuerySortBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortByBudget() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'budget', Sort.asc);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortByBudgetDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryModelQuerySortThenBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenByBudget() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'budget', Sort.asc);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenByBudgetDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'budget', Sort.desc);
    });
  }
...
extension CategoryModelQueryWhereDistinct
  ...
  QueryBuilder<CategoryModel, CategoryModel, QDistinct> distinctByBudget() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryModelQueryProperty
  ...
  QueryBuilder<CategoryModel, double?, QQueryOperations> budgetProperty() {
    return QueryBuilder.apply(this, (query) {
