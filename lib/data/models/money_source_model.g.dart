...
part of 'money_source_model.dart';
...
extension GetMoneySourceModelCollection on Isar {
  IsarCollection<MoneySourceModel> get moneySourceModels => this.collection();
}

const MoneySourceModelSchema = CollectionSchema(
  name: r'MoneySourceModel',
  id: 6234431503335960756,
  properties: {
  ...
  estimateSize: _moneySourceModelEstimateSize,
  ...
  getLinks: _moneySourceModelGetLinks,
  attach: _moneySourceModelAttach,
  version: '3.1.0+1',
);

int _moneySourceModelEstimateSize(
  MoneySourceModel object,
  List<int> offsets,
...
void _moneySourceModelSerialize(
  MoneySourceModel object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
P _moneySourceModelDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
const _MoneySourceModeltypeEnumValueMap = {
  'cash': 0,
  'bankAccount': 1,
  'electronicWallet': 2,
};
const _MoneySourceModeltypeValueEnumMap = {
  0: SourceType.cash,
  1: SourceType.bankAccount,
  2: SourceType.electronicWallet,
};
...
extension MoneySourceModelQueryFilter
    on QueryBuilder<MoneySourceModel, MoneySourceModel, QFilterCondition> {
...
extension MoneySourceModelQueryObject
    on QueryBuilder<MoneySourceModel, MoneySourceModel, QFilterCondition> {}

extension MoneySourceModelQueryLinks
    on QueryBuilder<MoneySourceModel, MoneySourceModel, QFilterCondition> {}

extension MoneySourceModelQuerySortBy
    on QueryBuilder<MoneySourceModel, MoneySourceModel, QSortBy> {
  ...
  QueryBuilder<MoneySourceModel, MoneySourceModel, QAfterSortBy> sortByType() {
    return QueryBuilder.apply(this, (query) {
...
extension MoneySourceModelQuerySortThenBy
    on QueryBuilder<MoneySourceModel, MoneySourceModel, QSortThenBy> {
  QueryBuilder<MoneySourceModel, MoneySourceModel, QAfterSortBy>
      thenByBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'balance', Sort.asc);
  ...
  QueryBuilder<MoneySourceModel, MoneySourceModel, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoneySourceModel, MoneySourceModel, QAfterSortBy> thenByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }
...
extension MoneySourceModelQueryWhereDistinct
    on QueryBuilder<MoneySourceModel, MoneySourceModel, QDistinct> {
  QueryBuilder<MoneySourceModel, MoneySourceModel, QDistinct>
      distinctByBalance() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoneySourceModel, MoneySourceModel, QDistinct> distinctByType() {
    return QueryBuilder.apply(this, (query) {
...
extension MoneySourceModelQueryProperty
  ...
  QueryBuilder<MoneySourceModel, double, QQueryOperations> balanceProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoneySourceModel, String, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'name');
    });
  }

  QueryBuilder<MoneySourceModel, SourceType, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
